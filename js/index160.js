...
//foreach() applies a function to each item in an array
// the parameter of the function represents each item in the array.
games.forEach(function(x){
    for (i = 0; i < propertiesNames.length; i++){
        console.log(`${propertiesNames[i]}: ` + x[propertiesNames[i]])
    }
})
