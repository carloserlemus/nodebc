...
for (i = 0; i <= 2; i++){
    console.log('Name: ' + gamesCollection[i].name)
    console.log('Price: ' + gamesCollection[i].price)
    console.log('Sold: ' + gamesCollection[i].sold)
    console.log('Console: ' + gamesCollection[i].console)
    console.log('-----')
}
