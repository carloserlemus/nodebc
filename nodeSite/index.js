...
const superheroes = [
  ...
  { id: 2, name: 'CAPTAIN MARVEL', image: 'captain_marvel.jpg' },
  { id: 3, name: 'HULK', image: 'the_hulk.jpg' },
  { id: 4, name: 'THOR', image: 'thor.jpg' },
  { id: 5, name: 'IRON MAN', image: 'ironman.jpg' },
  { id: 6, name: 'DAREDEVIL', image: 'daredevil.jpg' },
  { id: 7, name: 'BLACK WIDOW', image: 'black_widow.jpg' },
  { id: 8, name: 'CAPTAIN AMERICA', image: 'captain_america.jpg' },
